...
def test_fit_result(fit_engine):
    ...
    sp_ref1 = {f'p{item1.unique_name}': item1.value for item1, item2 in zip(sp_sin._kwargs.values(), ref_sin._kwargs.values())}
    sp_ref2 = {f'p{item1.unique_name}': item2.value for item1, item2 in zip(sp_sin._kwargs.values(), ref_sin._kwargs.values())}
