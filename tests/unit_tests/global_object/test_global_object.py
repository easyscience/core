...
class TestGlobalObject:
    ...
    def test_generate_unique_name_already_taken(self):
        ...
        keep_due_toweakref_1 = DescriptorBool(value=True, unique_name="other_name_prefix_2")
        keep_due_toweakref_2 = DescriptorBool(value=True, unique_name="other_name_prefix_a_3")
        keep_due_toweakref_3 = DescriptorBool(value=True, unique_name="almost_other_name_prefix_3")
