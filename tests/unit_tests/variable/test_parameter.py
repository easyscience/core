...
class TestParameter:
    ...
    def test_parameter_from_dependency_with_desired_unit(
        self, normal_parameter: Parameter
    ):
        # When Then
        dependent_parameter = Parameter.from_dependency(
    ...
    def test_dependent_parameter_with_unique_name(
        ...
        assert dependent_parameter.dependency_map == {
            "__Parameter_0__": normal_parameter
        }
        self.compare_parameters(dependent_parameter, 2 * normal_parameter)
    ...
    def test_process_dependency_unique_names_single_quotes(
        ...
        assert (
            normal_parameter._clean_dependency_string
            == "__Special_name__ + __Special_name_2__"
        )
    ...
    def test_process_dependency_unique_names_exception_not_a_descriptorNumber(
        ...
        with pytest.raises(
            ...
            normal_parameter._process_dependency_unique_names(
                dependency_expression='2*"base_obj"'
            )
    ...
    def test_parameter_make_dependent_on_exceptions_cleanup_previously_dependent(
        ...
        # When
        independent_parameter = Parameter(
            name="independent", value=10, unit="s", variance=0.02
        )
        dependent_parameter = Parameter.from_dependency(
            name="dependent",
    ...
    def test_dependent_parameter_return_is_descriptor_number(self):
        ...
        descriptor_number = DescriptorNumber(
            name="descriptor", value=1, unit="m", variance=0.01
        )
    ...
    def test_dependent_parameter_overwrite_dependency(
        self, normal_parameter: Parameter
    ):
        # When
        dependent_parameter = Parameter.from_dependency(
    ...
    def test_independent_parameter_dependency_expression(
        self, normal_parameter: Parameter
    ):
        # When Then Expect
        with pytest.raises(AttributeError):
    ...
    def test_dependent_parameter_dependency_expression_setter(
        self, normal_parameter: Parameter
    ):
        # When
        dependent_parameter = Parameter.from_dependency(
    ...
    def test_dependent_parameter_dependency_map_setter(
        self, normal_parameter: Parameter
    ):
        # When
        dependent_parameter = Parameter.from_dependency(
    ...
    def test_set_desired_unit_incompatible_units_raises(
        self, normal_parameter: Parameter
    ):
        # When Then
        dependent_parameter = Parameter.from_dependency(
    ...
    def test_set_desired_unit_incorrect_unit_type_raises(
        self, normal_parameter: Parameter
    ):
        # When Then
        dependent_parameter = Parameter.from_dependency(
    ...
    def test_repr(self, parameter: Parameter):
        ...
        assert (
            repr(parameter)
            == "<Parameter 'name': 1.0000 ± 0.1000 m, bounds=[0.0:10.0]>"
        )
    ...
    def test_repr_fixed(self, parameter: Parameter):
        ...
        assert (
            repr(parameter)
            == "<Parameter 'name': 1.0000 ± 0.1000 m (fixed), bounds=[0.0:10.0]>"
        )
    ...
    def test_addition_with_descriptor_number(self, parameter: Parameter):
        ...
        parameter._callback = property()
        descriptor_number = DescriptorNumber(
            name="test", value=1, variance=0.1, unit="cm"
        )
    ...
    def test_subtraction_with_parameter_nan_cases(self):
        # When
        parameter = Parameter(
            name="name", value=1, variance=0.01, min=-np.inf, max=np.inf
        )
    ...
    def test_multiplication_with_parameter_nan_cases(
        self, test, expected, expected_reverse
    ):
        # When
    ...
    def test_division_with_parameter(
        self, parameter: Parameter, test, expected, expected_reverse
    ):
        # When
        parameter._callback = property()
    ...
    def test_zero_value_divided_by_parameter(
        self, parameter: Parameter, test, expected
    ):
        # When
        parameter._callback = property()
    ...
    def test_division_with_descriptor_number_missing_cases(
