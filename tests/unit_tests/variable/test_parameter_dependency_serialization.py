...
class TestParameterDependencySerialization:
    ...
    def test_dependent_parameter_serialization(self, clear_global_map):
        ...
        b = Parameter.from_dependency(name='b', dependency_expression='2 * a', dependency_map={'a': a}, unit='m')
    ...
    def test_multiple_dependent_parameters(self, clear_global_map):
        ...
        y = Parameter.from_dependency(name='y', dependency_expression='2 * x', dependency_map={'x': x}, unit='m')
    ...
    def test_backward_compatibility_base_deserializer(self, clear_global_map):
        ...
        b = Parameter.from_dependency(name='b', dependency_expression='3 * a', dependency_map={'a': a}, unit='m')
