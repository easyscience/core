...
class TestDesciptorBase:
    ...
    @pytest.mark.parametrize(
        'display_name', [1, True, 1.0, [], {}, (), object()], ids=['int', 'bool', 'float', 'list', 'dict', 'tuple', 'object']
    )
    ...
    @pytest.mark.parametrize(
        'description', [1, True, 1.0, [], {}, (), object()], ids=['int', 'bool', 'float', 'list', 'dict', 'tuple', 'object']
    )
    ...
    @pytest.mark.parametrize(
        'url', [1, True, 1.0, [], {}, (), object()], ids=['int', 'bool', 'float', 'list', 'dict', 'tuple', 'object']
    )
