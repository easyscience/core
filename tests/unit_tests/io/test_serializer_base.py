...
from easyscience import DescriptorNumber, Parameter, global_object
...
class MockSerializerWithRedirect(SerializerComponent):
    ...
    _REDIRECT = {
        'special_attr': lambda obj: obj.value * 2,
        'none_attr': None
    }
...
class TestSerializerBase:
    ...
    def test_recursive_encoder_with_nested_structures(self, serializer, clear):
        ...
        data = {
            "level1": {
                "level2": [mock_obj, {"level3": mock_obj}]
            }
        }
