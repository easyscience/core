...
from easyscience.fitting.calculators.interface_factory import InterfaceFactoryTemplate, ItemContainer
...
class TestInterfaceFactoryTemplate:
    ...
    def test_init_with_specific_interface_name(self, clear, mock_interface1, mock_interface2):
        ...
        # When
        factory = InterfaceFactoryTemplate([mock_interface1, mock_interface2], interface_name="MockInterface2")
    ...
    def test_create_without_interface_name_uses_first(self, factory_multiple_interfaces, mock_interface1):
    ...
    def test_switch_with_fitter_having_fit_object_with_update_bindings(self, factory_single_interface):
    ...
    def test_state_restore_static_method_implementation_issue(self, clear, mock_interface1, mock_interface2):
        ...
        with pytest.raises(TypeError):
            InterfaceFactoryTemplate.__state_restore__(
                InterfaceFactoryTemplate, "MockInterface2"
            )
    ...
    def test_switch_with_fitter_generate_bindings_exception(self, factory_single_interface, capsys):
    ...
    def test_generate_bindings_with_property_without_value_no_call_back(self, factory_single_interface):
...
class TestItemContainer:
    ...
    def test_item_container_creation(self, item_container):
        ...
        assert item_container.name_conversion == {"param1": "internal_param1", "param2": "internal_param2"}
