...
:Related PR: `#180 - New collection base <https://github.com/easyscience/corelib/pull/180>`_
...
- `Python MutableSequence <https://docs.python.org/3/library/collections.abc.html#collections.abc.MutableSequence>`_
- `Type Hints PEP 484 <https://www.python.org/dev/peps/pep-0484/>`_
