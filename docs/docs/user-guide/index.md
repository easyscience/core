...
**key parameters** and **workflow steps** required for using EasyScience
effectively.
...
- [Parameters](#) – Describes how parameters are structured, named, and
  accessed within the EasyScience.
- [First Steps](#) – Shows how to begin using EasyScience in Python
