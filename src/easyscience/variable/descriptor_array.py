...
class DescriptorArray(DescriptorBase):
    ...
    def __init__(
        ...
        *,
        ...
        unit : Optional[Union[str, sc.Unit]], default=''
            ...
            default, ''.
        variance : Optional[Union[list, np.ndarray]], default=None
            The variances of the values, with the same shape as
        ...
        parent : Optional[Any], default=None
            ...
            None.
        dimensions : Optional[list], default=None
            List of dimensions to pass to scipp. Autogenerated if not
    ...
    @classmethod
    def from_scipp(cls, full_value: Variable, **kwargs: Any) -> DescriptorArray:
        """
    ...
    def __repr__(self) -> str:
        ...
        its display name, value, variance, and unit.

        Large arrays are summarized for brevity.
        """
        # Base string with display name
        string = f"<{self.__class__.__name__} '{self.display_name}': "
    ...
    def _apply_operation(
        ...
        return DescriptorArray.from_scipp(full_value=new_full_value)
    ...
    def __pow__(self, other: Union[DescriptorNumber, numbers.Number]) -> DescriptorArray:
        ...
        return DescriptorArray.from_scipp(full_value=new_value)
    ...
    def __getitem__(self, a) -> DescriptorArray:
        ...
        """
        return DescriptorArray.from_scipp(full_value=self.full_value.__getitem__(a))
    ...
    def trace(
        ...
        return constructor(full_value=trace)
    ...
    def sum(
        ...
        return constructor(full_value=new_full_value)
